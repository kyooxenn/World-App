...
public enum ErrorType {
	...
	UserAlreadyExist("UserAlreadyExistError", "User already registered! Please try again.", HttpStatus.CONFLICT),
	...
	DeleteLogsFailed("DeleteLogsFailedError","请选择一个ID"),
